  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 glass">
      <div className="mx-auto max-w-6xl flex items-center justify-between px-6 h-14 md:h-16">
        <a
          href="#"
          className="text-sm font-medium text-text-primary tracking-widest uppercase hover:text-accent transition-colors duration-300"
        >
          A. Марков
        </a>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="btn-pdf hidden md:inline-flex text-xs"
          >
            <Download size={13} />
            PDF
          </a>
